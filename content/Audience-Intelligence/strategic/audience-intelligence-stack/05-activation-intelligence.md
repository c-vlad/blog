...
bookHidden: false
date: 2026-01-02
series: ["Audience Intelligence Stack"]
categories: ['audience intelligence', 'strategy']
tags: ['activation intelligence', 'influencer selection', 'channel optimization', 'content strategy', 'campaign architecture', 'tactical execution']
---

# 5 Layer 3 - Activation Intelligence

{{< img src="/images/strategic/ActivationIntelligence.png" >}}
...
Many marketing teams operate almost exclusively at the Activation layer. They ask tactical questions without strategic context:
...
* Identify <span style="color:#144594;">@FitLifeJenna</span> (850K followers, 4.2% engagement rate, $15K per sponsored post)  
...
#### What Layer 1 (Strategic Intelligence) would have revealed

<span style="color:#144594;">@FitLifeJenna</span>'s audience has **minimal overlap** with StrideRecover's core audience.
...
Jenna's followers are interested in fitness-as-lifestyle and athleisure fashion, not performance athletics and recovery science. They're closer to the *ComfyCasual* audience psychographic (casual comfort, self-expression) than *StrideRecover*'s (performance optimization, serious athletics).
{{< /callout >}}

{{< callout "highlight" "Strategic Intelligence verdict" >}}
**Wrong audience.** High reach into people who won't convert.
{{< /callout >}}

#### What Layer 2 (Psychographic Intelligence) would have revealed
...
{{< callout "highlight" "Psychographic Intelligence verdict" >}}
**Motivational mismatch.** Even if they saw the product, they wouldn't understand why they need specialized recovery footwear. They want cute, comfortable slides for lounging, not biomechanical support for post-marathon recovery.
{{< /callout >}}
...
<span style="color:#2c3b53;">**Primary partnership: @RunCoachKatie (120K followers)**</span>
...
* Content:
	- *"How I Use StrideRecover in Marathon Training"*
	- *"The Science of Recovery Footwear"*
	- *"Post-Long-Run Recovery Protocol"*
...
<span style="color:#144594;">@FitLifeJenna</span> had better surface-level metrics (more followers, higher engagement rate, lower CPM). But **without Strategic and Psychographic Intelligence, those metrics were irrelevant.** She reached the wrong people with the wrong message.

<span style="color:#2c3b53;">@RunCoachKatie</span> had smaller reach but **strategic and psychographic alignment**. Her audience:
...
{{< callout "highlight" >}}
**Activation Intelligence isn't about finding the biggest influencer.**

**It's about finding the right influencer for this specific audience and value proposition.**

**Which you can only know with Layers 1 and 2**
{{< /callout >}}
...
<span style="color:#144594;">Compare to:</span>
...
{{< callout "highlight" "Strategic Intelligence verdict" >}}
**Wrong audience** (despite larger follower count)
{{< /callout >}}
{{< /callout >}}
...
<span style="color:#2c3b53;">@RunCoachKatie</span> (120K followers)
...
**Example partnership brief for <span style="color:#2c3b53;">@RunCoachKatie</span>:**
...
{{< callout "highlight" "The key insight" >}}
...
- **Audience mindset:** Information-seeking, research mode, evaluating solutions
- **Content format:** Educational, evidence-based, detailed
- **Tone:** Expert, credible, technical
...
- **Audience mindset:** Planning, aspiration, collecting ideas
- **Content format:** Visual, aspirational, actionable
- **Tone:** Warm, accessible, holistic
...
- **Audience mindset:** Real-time, conversational, community-engaged
- **Content format:** Short, reactive, engaging
- **Tone:** Authentic, supportive, knowledgeable

**Example content:**

* Race day support: "Running Boston today? Your feet are heroes. Treat them to recovery."  
...
- **Audience mindset:** Shopping mode, practical, value-conscious
- **Content format:** Product-focused, benefit-clear, accessible
- **Tone:** Straightforward, trustworthy, approachable
...
- **Audience mindset:** Pre-race preparation or post-race recovery, high engagement
- **Content format:** Experiential, social proof, immediate benefit
- **Tone:** Celebratory, supportive, expert-backed
...
1. **Platform context** (Pinterest \= planning, Twitter \= real-time, Runner's World \= research)  
2. **Audience mindset** (information-seeking vs. transactional vs. aspirational)  
3. **Segment served** (Dedicated Athletes vs. Family Managers vs. Comfort Seekers)
...
* **Channels:** Runner's World product reviews, influencer partnerships (<span style="color:#2c3b53;">@RunCoachKatie</span>), comparison content  
...
* **Channels:** Influencer partnerships (<span style="color:#2c3b53;">@RunCoachKatie</span>), Runner's World product features, retargeting ads  
...
| -- | -- | -- | -- | -- | -- | -- | -- |
| <span style="color:#2c3b53;">@RunCoachKatie</span> | 120K | $24K | 312 | $20,280 | \-18% | 42% | \+68 |
...
**<span style="color:#2c3b53;">@RunCoachKatie</span>:**
...
* Shift @UltraTrailGuy's $30K budget to double down on @MarathonMindset ($40K total) and <span style="color:#2c3b53;">@RunCoachKatie</span> ($30K total)  
...
* **Activation Intelligence:** Partner with <span style="color:#2c3b53;">@RunCoachKatie</span> (audience overlap \+ credibility), create content about "integrating recovery into training plans" (resonant message), activate on Runner's World and marathon expos (right channels), sequence touchpoints through awareness → consideration → conversion (matches decision process)
...
* **Layer 1:** <span style="color:#325998;">Who to reach (and who not to reach)</span> 
* **Layer 2:** <span style="color:#325998;">What motivates them and why they choose</span> 
* **Layer 3:** <span style="color:#325998;">How to reach them, what to say, and when to say it</span> 
