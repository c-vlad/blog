...
tags: ['framework', 'integration', 'workflow', 'strategic decision-making', 'case study', 'intelligence cycle']
---

# **6 How the Layers Work Together**

{{< img src="/images/strategic/HowTheLayersWorkTogether.png" >}}
...
Strategic Intelligence revealed that <span style="color:#144594;">@FitLifeJenna</span>'s audience has minimal overlap with StrideRecover (0.8% reach, wrong audience).
...
```mermaid
graph TB
    A[Strategic Question] -->|"What do we need to know?"| B["Layer 1
    Strategic Intelligence"]
    B -->|"Who to target/avoid"| C["Layer 2
    Psychographic Intelligence"]
    C -->|"Why they choose"| D["Layer 3
    Activation Intelligence"]
    D -->|"How to execute"| E[Campaign Launch]
    E -->|"Results & data"| F[Measure & Learn]
    F -->|"Update insights"| G[Refine Intelligence]
    G -->|"New question"| A
