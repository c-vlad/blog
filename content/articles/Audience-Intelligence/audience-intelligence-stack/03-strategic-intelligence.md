...
quadrantChart
    ...
    y-axis "Low Penetration" --> "High Penetration"
    quadrant-1 "Symmetric Comp."
    quadrant-2 "Niche Dom."
    quadrant-3 "Minimal Overlap"
    quadrant-4 "Asymmetric Threat"
    "ComfyCasual": [0.12, 0.1]
    "Brooks Running": [0.31, 0.62]
    "Compression Gear": [0.13, 0.54]
```
